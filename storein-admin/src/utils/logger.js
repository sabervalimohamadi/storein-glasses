...
export const logger = {
  ...
  error(message, error = null, meta = {}, context = 'Admin') {
  ...
  apiError(endpoint, statusCode, message, meta = {}) {
    ...
    } else if (statusCode >= 400 && statusCode !== 401 && statusCode !== 403 && statusCode !== 422) {
