  ...
  <div class="container-main py-4">
    ...
    <div class="rounded-xl shadow-card px-5 py-4 mb-4" style="background-color: var(--color-card);">
      <div class="flex items-center gap-3 flex-wrap">
        <svg class="w-5 h-5 text-brand flex-shrink-0" fill="none"
        ...
        <span
          ...
          class="text-text-secondary text-sm font-fanum mr-auto"
        >
    ...
    <div
      v-if="!loading && products.length === 0 && searchQuery"
    ...
    >
      ...
      <p class="text-text-secondary mb-6 text-sm leading-7">
        لغت کلیدی دیگری امتحان کنید یا محصولات ما را مرور کنید
      </p>
      <RouterLink
        to="/products"
        class="inline-block bg-brand text-white font-bold px-6 py-3
               rounded-xl hover:bg-brand-dark transition-colors"
      >
        مشاهده همه محصولات
      </RouterLink>
    </div>
...
// Re-fetch when user types a new search in the header
